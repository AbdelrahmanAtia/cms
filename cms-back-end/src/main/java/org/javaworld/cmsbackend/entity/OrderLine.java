...
public class OrderLine {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "orderline_seq_gen")
	@SequenceGenerator(sequenceName = "orderline_seq", allocationSize = 1, name = "orderline_seq_gen")
	@Column(name = "id")
	private int id;
